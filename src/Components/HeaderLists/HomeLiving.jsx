const HomeLiving=()=>{
    ...
    const Bath=['Bath Towels','Hand Towels','Face Towels','Beach Towels','Towel Sets','Towel Accessories','Bath Mats','Bath Robes'];
    ...
    const storage=['Boxes','Baskets','Organisers','Racks & Shelves','Hooks & Holders','Storage Bags','Storage Boxes','Storage Baskets','Storage Organisers','Storage Racks','Storage Hooks','Storage Holders'];
    ...
    return(
        ...
        <div>
            <ul className=" my-4 pb-4 border-b-2 border-gray-300" >
                ...
                {
                    BedLinen.map((item,index)=>(<li className='text-sm my-1 text-gray-500 font-sans cursor-pointer' key={index}>{item}</li>))
                }
            </ul>
            ...
            <ul className=" my-4 pb-4">
                ...
                {
                    Flooring.map((item,index)=>(<li className='text-sm my-1 text-gray-500 font-sans cursor-pointer' key={index}>{item}</li>))
                }
            </ul>
        </div>
        ...
        <ul className="my-4 pb-4 border-b-2 border-gray-300">
                ...
                {
                    Bath.map((item,index)=>(<li className='text-sm my-1 text-gray-500 font-sans cursor-pointer' key={index}>{item}</li>))
                }
            </ul>
            ...
            <ul className="my-4 pb-4">
                ...
                {
                    Lamps.map((item,index)=>(<li className='text-sm my-1 text-gray-500 font-sans cursor-pointer' key={index}>{item}</li>))
                }
            </ul>
        </div>
        ...
        <ul className="border-b-2 border-gray-300 my-4 pb-4">
                ...
                {
                    HomeDecor.map((item,index)=>(<li className='text-sm my-1 text-gray-500 font-sans cursor-pointer' key={index}>{item}</li>))
                }
            </ul>
        ...
        <ul className="border-b-2 border-gray-300 my-4 pb-4">
            ...
            <ul>
                ...
                {
                    Kitchen.map((item,index)=>(<li className='text-sm my-1 text-gray-500 font-sans cursor-pointer' key={index}>{item}</li>))
                }
        ...
        <ul className=" my-4 pb-4 ">
                ...
                {
                storage.map((item,index)=>(<li className='text-sm my-1 text-gray-500 font-sans cursor-pointer' key={index}>{item}</li>))
                }
            </ul>
