    ...
    return (
        <div className="mt-[150px]">
                ...
                <form className="w-4/12 mx-auto " onSubmit={(e)=>e.preventDefault()}>
                    ...
                    <button className="py-3 px-6 font-bold rounded-xl mx-auto bg-blue-400 hover:bg-blue-600 text-white text-lg flex justify-center" onClick={()=>navigate("/checkout/payU")}>Next</button>
                </form>
                </div>
    )
}
